...
**디자인 기준:** 디자인 시스템 v3.5 (Source of Truth)
...
const config: Config = {
  ...
  theme: {
    extend: {
      // 폰트 - CSS Variable 참조 (디자인 시스템 v3.5 기준)
      fontFamily: {
...
```
```css
/* app/globals.css — 디자인 시스템 v3.5 기준 */
...
5. **색상 코드:** 반드시 디자인 시스템 v3.5의 값을 사용할 것 (Electric Primary: `#0047FF`, Warm Primary: `#0F172A`, Warm Accent: `#EA580C`).
