  ...
  return (
    <div className="p-6 sm:p-8 space-y-4">
      ...
      <button
        ...
        className="w-full p-4 rounded-xl border-2 border-gray-200 hover:border-brand-300 hover:bg-brand-50/50 transition-all duration-200 text-left group disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-full bg-yellow-100 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            <Heart size={20} strokeWidth={1.5} className="text-yellow-600" />
          </div>
          <div>
      ...
      <button
        ...
        disabled={isLoading !== null}
        className="w-full p-4 rounded-xl border-2 border-gray-200 hover:border-green-300 hover:bg-green-50/50 transition-all duration-200 text-left group disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            {isLoading === 'confirm' ? (
              <Loader2 size={20} strokeWidth={1.5} className="text-green-600 animate-spin" />
            ) : (
      ...
      <button
        ...
        disabled={isLoading !== null}
        className="w-full p-4 rounded-xl border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50/50 transition-all duration-200 text-left group disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            <PenLine size={20} strokeWidth={1.5} className="text-blue-600" />
          </div>
          <div>
            <h3 className="font-semibold text-brand-800 mb-1">
              후기 남기기
