      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        {meetingOptions.length > 0 && (
          <select
            ...
            className="px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-transparent bg-bg-surface w-full sm:min-w-[180px] sm:w-auto"
          >
