...
export default function Footer() {
  ...
  return (
    <footer className="bg-warm-50 border-t border-warm-100">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          {/* 브랜드 */}
          <div className="flex items-center gap-2">
            <span className="text-xl">📚</span>
            <span className="font-semibold text-warm-700">지독해</span>
            <span className="text-sm text-warm-500">경주·포항 독서모임</span>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-warm-200">
          <p className="text-xs text-warm-400 text-center md:text-left">
