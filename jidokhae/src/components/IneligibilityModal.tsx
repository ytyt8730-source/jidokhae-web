        ...
        <>
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
              ...
              {/* 자격 상태 정보 */}
              <div className="bg-warm-50 rounded-xl p-4 mb-6 space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-warm-500">마지막 정기모임</span>
                  <span className="text-warm-700 font-medium">{formattedLastMeeting}</span>
                </div>
                {isExpired ? (
                  <div className="flex justify-between text-sm">
                    <span className="text-warm-500">상태</span>
                    <span className="text-error font-medium">자격이 만료되었어요</span>
                  </div>
                ) : daysRemaining !== null ? (
                  <div className="flex justify-between text-sm">
                    <span className="text-warm-500">남은 기간</span>
              ...
              {/* 안내 메시지 */}
              <p className="text-center text-warm-600 mb-6 text-sm">
                먼저 정기모임에 참여해주세요!
              </p>
